...
public class AdminInterfaceImpl implements AdminInterface{
	 ...
	 */
	@Override
	public void addCourse(Course newCourse, List<Course> courseList) throws CourseAlreadyExistsException {
		...
		if(!AdminValidator.isValidNewCourse(newCourse, courseList)) {
			...
			throw new CourseAlreadyExistsException(newCourse.getCourseCode());
		}
