...
public class SQLQueriesConstants {
	...
	public static final String ADD_COURSE_QUERY = "insert into coursecatalog(courseid, courseName, professorid, availableseats) values (?, ?, ?, ?)";
	public static final String VIEW_PENDING_ADMISSION_QUERY = "select student.studentId, student.studentname, user.userId,user.password, user.role from student, user  where student.isapproved = 0 and " +
	...
	public static final String ADD_PROFESSOR_QUERY = "insert into Professor(professorid, professorname, department, designation) values (?, ?, ?, ?)";
	public static final String ASSIGN_COURSE_QUERY = "update coursecatalog set professorId = ? where courseCode = ?";
	public static final String VIEW_COURSE_QUERY = "select * from coursecatalog";
