...
public class SQLQueriesConstants {
    ...
    public static final String GET_PROF_NAME = "select name from professor where professorId = ?";
    ...
    public static final String GET_ENROLLED_STUDENTS="select course.courseId,course.courseName,registeredcourse.studentId from course inner join registeredcourse on course.courseId = registeredcourse.courseid where (course.courseId = ? and course.professorid=?)  order by course.courseid";
