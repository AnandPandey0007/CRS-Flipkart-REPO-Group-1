...
public class SQLQueriesConstants {
    ...
    public static final String DECREMENT_COURSE_SEATS="update coursecatalog set availableseats = availableseats-1 where courseCode = ? ";

    public static final String ADD_COURSE="insert into registeredcourses (courseid, professorid, studentid) values ( ? , ? , ? )";
